...
const listaExtrato = document.getElementById('lista-extrato') as HTMLUListElement;
...
export class Extrato {
    static numeroDeTransacoes: number[] = JSON.parse(localStorage.getItem('listIDs') || '[]');

    constructor() {}

    static transacaoIDs(): number {
        let i = 1;
    ...
    static atualizarExtrato(transacao: tipoTransacao) {
    ...
    static carregarExtratoSalvo() {
        this.numeroDeTransacoes.forEach((id: number) => {
